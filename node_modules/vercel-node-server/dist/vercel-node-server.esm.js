...
var enhanceRequest = function enhanceRequest(req) {
  try {
    ...
    return Promise.resolve(buffer(reqClone)).then(function (body) {
...
export { ApiError, createServer, enhanceRequest, enhanceResponse };
//# sourceMappingURL=vercel-node-server.esm.js.map
